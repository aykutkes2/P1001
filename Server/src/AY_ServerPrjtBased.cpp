...
const Ui08 SERVER_Dns[] = "datakomip.dyndns.org";
const Ui08 MyMac[6] = {0x60,0xF6,0x77,0xBE,0x5F,0x30};
const Ui08 MyUnique[12] = {0x60,0xF6,0x77,0xBE,0x5F,0x30,0x60,0xF6,0x77,0xBE,0x5F,0x30};
/*
=========== Demo Configurations ================
...
*/
const Ui16 DEMO_SRV_Port = 1982;
const Ui08 DEMO_SRV_IP[4] = { 192,168,2,149 };
const Ui08 DEMO_SRV_MAC[6] = { 0x74,0xD4,0x35,0x3C,0x4A,0xB4 };
const Ui08 DEMO_SRV_UNIQUE[12] = { 0x74,0xD4,0x35,0x3C,0x4A,0xB4,0x74,0xD4,0x35,0x3C,0x4A,0xB4 };
const Ui08 DEMO_Mac[6] = { 0xFF,0xFF,0xFF,0xFF,0xFF,0xFF };
const Ui08 DNS_SRV_IP[4] = { 8,8,8,8 };
const Ui16 DNS_Port = 53;

const Ui32 LOCAL_CertNo = 0;
const Ui32 SERVER_CertNo = 0;

const Ui08 * const CLIENT_PUB_KEY = (Ui08 *)
	"-----BEGIN PUBLIC KEY-----\n"
...
const Ui08 * const CLIENT_PR_KEY = (unsigned char *)
